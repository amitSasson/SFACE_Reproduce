...
boot_func <- function(df, estimand_func_vec, sface = "sface1", BS = 50)
{
...
boot_func_diff <- function(df, estimand_func_vec, sface = "sface1", BS = 50)
{
...
ans <- compute_stats_sface_sample_sizes(sizes = c(args),
...
save(ans, file = str_c("sample_sizes_RR_", as.character(args),"_", Sys.time(), ".RData"))
