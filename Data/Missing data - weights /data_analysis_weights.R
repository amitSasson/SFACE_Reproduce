...
q <- qnorm(0.975)
M <- 100000
df <- read_csv("/udd/nhasn/data_after_weights_for_analysis_60_70.csv")
...
save(ans, file = str_c("data_diff_sface1_60_70", ".RData"))

ans <- compute_stats_sface(df,"sface2")
save(ans, file = str_c("data_diff_sface2_60_70", ".RData"))
...
save(ans, file = str_c("data_RR_sface1_60_70",".RData"))

ans <- compute_stats_sface_RR(df,"sface2")
save(ans, file = str_c("data_RR_sface2_60_70", ".RData"))
